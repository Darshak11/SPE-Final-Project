  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path='/signup' element={<Signup onLoginSuccess={handleLoginSuccess} isLoggedIn={isLoggedIn}/>} />
        <Route path='/A_dashboard' element={<A_dashboard onLogout={handleLogout} isLoggedIn={isLoggedIn}/>} />
        </Routes>
    </Router>
  );
};
